...
- **Key Features**:
    ...
    - **Ticket Management**: Comprehensive system with ServiceNow-style fields, advanced specialized fields (attachments, notes, communication, history, internal actions), hierarchical configurations (category → subcategory → action), and dynamic metadata.
    ...
    - **Timecard/Journey Management**: Comprehensive system for time registration, attendance, work schedules, and absence management, compliant with labor laws (CLT). Integration with Team Management users completed for employee field selection in work schedules.
