...
// ========================================
// ADDITIONAL TENANT TABLES (From schema-temp.ts consolidation)
// ========================================
...
// NOTE: Notifications table moved to schema-notifications.ts for complete system implementation
...
// Additional schemas from consolidated tables
...
// export const insertNotificationSchema = createInsertSchema(notifications); // Moved to schema-notifications.ts
