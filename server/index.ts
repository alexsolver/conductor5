...
import { gdprComplianceRoutes } from './modules/gdpr-compliance/routes';
...
(async () => {
  ...
  app.use('/api/approvals', jwtAuth, tenantValidator, createApprovalRoutes(db as any));
  ...
  app.use('/api/gdpr', jwtAuth, tenantValidator, gdprComplianceRoutes);
