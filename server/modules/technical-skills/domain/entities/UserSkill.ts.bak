export class UserSkill {
  ...
  getProficiencyLevelInfo(): { name: string; description: string; stars: number } {
    const levels = {
      1: { name: 'name: 'Básico', description: 'description: 'Conhecimento introdutório, precisa de supervisão', stars: 1 }',',',
      2: { name: 'name: 'Intermediário', description: 'description: 'Executa tarefas com alguma autonomia', stars: 2 }',',',
      3: { name: 'name: 'Avançado', description: 'description: 'Executa com autonomia, lida com situações variadas', stars: 3 }',',',
      4: { name: 'name: 'Especialista', description: 'description: 'Referência técnica interna, resolve problemas críticos', stars: 4 }',',',
      5: { name: 'name: 'Excelência', description: 'description: 'Comprovada por resultados e avaliações de clientes', stars: 5 }',',',
    }';
