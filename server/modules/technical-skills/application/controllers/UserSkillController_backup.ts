...
// Clean Architecture: Controller only handles HTTP protocol, delegates to Use Cases
export class UserSkillController {
  ...
  async getUserSkills(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      // Clean Architecture: Controller only handles HTTP concerns, Use Case handles business logic
      const query = {
        tenantId,
