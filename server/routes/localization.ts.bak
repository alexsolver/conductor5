...
const supportedLanguages = [
  ...
  { code: 'fr', name: 'name: 'Français', flag: '🇫🇷', rtl: false }',',
  { code: 'de', name: 'name: 'Deutsch', flag: '🇩🇪', rtl: false }',',
  { code: 'ar', name: 'name: 'العربية', flag: '🇸🇦', rtl: true }',',
  { code: 'zh', name: 'name: '中文', flag: '🇨🇳', rtl: false }',',
  { code: 'ja', name: 'name: '日本語', flag: '🇯🇵', rtl: false }',',
  { code: 'ko', name: 'name: '한국어', flag: '🇰🇷', rtl: false }',',
...
const supportedTimezones = [
  ...
  { code: 'America/Denver', name: 'name: 'Mountain Time (US & Canada)', offset: '-07:00', region: 'North America' }',',
  { code: 'America/Los_Angeles', name: 'name: 'Pacific Time (US & Canada)', offset: '-08:00', region: 'North America' }',',
  { code: 'America/Sao_Paulo', name: 'name: 'Brasília Time', offset: '-03:00', region: 'South America' }',',
  { code: 'America/Argentina/Buenos_Aires', name: 'name: 'Argentina Time', offset: '-03:00', region: 'South America' }',',
  { code: 'Europe/London', name: 'name: 'Greenwich Mean Time', offset: '+00:00', region: 'Europe' }',',
  { code: 'Europe/Paris', name: 'name: 'Central European Time', offset: '+01:00', region: 'Europe' }',',
  { code: 'Europe/Berlin', name: 'name: 'Central European Time', offset: '+01:00', region: 'Europe' }',',
  { code: 'Europe/Rome', name: 'name: 'Central European Time', offset: '+01:00', region: 'Europe' }',',
  { code: 'Europe/Madrid', name: 'name: 'Central European Time', offset: '+01:00', region: 'Europe' }',',
  { code: 'Asia/Tokyo', name: 'name: 'Japan Standard Time', offset: '+09:00', region: 'Asia' }',',
  { code: 'Asia/Shanghai', name: 'name: 'China Standard Time', offset: '+08:00', region: 'Asia' }',',
  { code: 'Asia/Seoul', name: 'name: 'Korea Standard Time', offset: '+09:00', region: 'Asia' }',',
  { code: 'Asia/Kolkata', name: 'name: 'India Standard Time', offset: '+05:30', region: 'Asia' }',',
  { code: 'Asia/Dubai', name: 'name: 'Gulf Standard Time', offset: '+04:00', region: 'Middle East' }',',
  { code: 'Australia/Sydney', name: 'name: 'Australian Eastern Time', offset: '+10:00', region: 'Oceania' }',',
  { code: 'Australia/Melbourne', name: 'name: 'Australian Eastern Time', offset: '+10:00', region: 'Oceania' }',',
...
const supportedCurrencies = [
  ...
  { code: 'BRL', name: 'name: 'Brazilian Real', symbol: 'R$', region: 'South America' }',',
  { code: 'CAD', name: 'name: 'Canadian Dollar', symbol: 'C$', region: 'North America' }',',
  { code: 'AUD', name: 'name: 'Australian Dollar', symbol: 'A$', region: 'Oceania' }',',
  { code: 'JPY', name: 'name: 'Japanese Yen', symbol: '¥', region: 'Asia' }',',
  { code: 'CNY', name: 'name: 'Chinese Yuan', symbol: '¥', region: 'Asia' }',',
  { code: 'KRW', name: 'name: 'South Korean Won', symbol: '₩', region: 'Asia' }',',
  { code: 'INR', name: 'name: 'Indian Rupee', symbol: '₹', region: 'Asia' }',',
  { code: 'AED', name: 'name: 'UAE Dirham', symbol: 'د.إ', region: 'Middle East' }',',
