...
CREATE TABLE IF NOT EXISTS tickets (
    ...
    environment_publication VARCHAR(255),
    publication_priority VARCHAR(100),
    close_to_publish BOOLEAN,
    related_project_id UUID,
    related_action_id UUID,
    action_conversion_data JSONB,
    ...
    action TEXT,
    is_active BOOLEAN DEFAULT true,
    link_ticket_number VARCHAR(255),
