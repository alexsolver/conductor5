  ...
  private async createDefaultIntegrations(tenantId: string): Promise<void> {
    try {
      ...
      const defaultIntegrations = ['
        ...
        {
          id: 'gmail-oauth2',
          name: 'name: 'Gmail OAuth2',',
          description: 'description: 'Integração OAuth2 com Gmail para envio e recebimento seguro de emails',',
        ...
        {
          id: 'outlook-oauth2',
          name: 'name: 'Outlook OAuth2',',
          description: 'description: 'Integração OAuth2 com Microsoft Outlook para emails corporativos',',
          category: 'Comunicação',
          icon: 'Mail',
        ...
        {
          id: 'email-smtp',
          name: 'name: 'Email SMTP',',
          description: 'description: 'Configuração de servidor SMTP para envio de emails automáticos e notificações',',
          category: 'Comunicação',
          icon: 'Mail',
        ...
        {
          id: 'imap-email',
          name: 'name: 'IMAP Email',',
          description: 'description: 'Conecte sua caixa de email via IMAP para sincronização de tickets',',
          category: 'Comunicação',
          icon: 'Inbox',
        ...
        }',
        {
          ...
          description: 'description: 'Integração com WhatsApp Business API para atendimento via WhatsApp',',
          category: 'Comunicação',
          icon: 'MessageSquare',
        ...
        }',
        {
          id: 'slack',
          name: 'name: 'Slack',',
          description: 'description: 'Notificações e gerenciamento de tickets através do Slack',',
          category: 'Comunicação',
          icon: 'MessageCircle',
        ...
        }',
        {
          ...
          description: 'description: 'Envio de SMS para notificações e alertas importantes',',
          category: 'Comunicação',
          icon: 'Phone',
        ...
        // Automação
        {
          id: 'zapier',
          name: 'name: 'Zapier',',
          description: 'description: 'Conecte com mais de 3000 aplicativos através de automações Zapier',',
          category: 'Automação',
          icon: 'Zap',
        ...
        }',
        {
          id: 'webhooks',
          name: 'name: 'Webhooks',',
          description: 'description: 'Receba notificações em tempo real de eventos do sistema',',
          category: 'Automação',
          icon: 'Webhook',
        ...
        {
          id: 'crm-integration',
          name: 'name: 'CRM Integration',',
          description: 'description: 'Sincronização com sistemas CRM para gestão unificada de clientes',',
          category: 'Dados',
          icon: 'Database',
        ...
        {
          id: 'dropbox-personal',
          name: 'name: 'Dropbox Pessoal',',
          description: 'description: 'Backup automático de dados e arquivos importantes',',
          category: 'Dados',
          icon: 'Cloud',
        ...
        // Segurança
        {
          id: 'sso-saml',
          name: 'name: 'SSO/SAML',',
          description: 'description: 'Single Sign-On para autenticação corporativa segura',',
          category: 'Segurança',
          icon: 'Shield',
        ...
        // Produtividade
        {
          ...
          description: 'description: 'Integração completa com Gmail, Drive e Calendar',',
        ...
        {
          id: 'chatbot-ai',
          name: 'name: 'Chatbot IA',',
          description: 'description: 'Assistente virtual inteligente para atendimento automatizado',',
          category: 'Produtividade',
          icon: 'Bot',
