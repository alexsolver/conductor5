  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        {/* Chatbots Tab - Simplified for lay users */}
        <TabsContent value="chatbots" className="space-y-6">
          {/* Header with simple explanation */}
          <div className="text-center py-4">
            <h2 className="text-2xl font-bold mb-2">🤖 Assistentes Virtuais</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Crie assistentes automáticos que conversam com seus clientes 24 horas por dia. 
              Escolha um modelo pronto ou personalize do seu jeito!
            </p>
          </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Modelos Prontos de Assistentes
              </CardTitle>
              <CardDescription>
                Clique em um modelo e tenha seu assistente funcionando em minutos!
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {/* Template 1: FAQ Bot */}
                <Card className="cursor-pointer hover:shadow-md transition-shadow border-blue-200 bg-blue-50/30" data-testid="card-template-faq-bot">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2 rounded-full bg-blue-100">
                      ...
                      <div>
                        <h3 className="font-medium">Assistente de Dúvidas</h3>
                        <p className="text-sm text-muted-foreground">Para perguntas frequentes</p>
                      </div>
                    </div>
                    <p className="text-sm mb-3">
                ...
                <Card className="cursor-pointer hover:shadow-md transition-shadow border-green-200 bg-green-50/30" data-testid="card-template-lead-bot">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <h3 className="font-medium">Coletor de Contatos</h3>
                        <p className="text-sm text-muted-foreground">Para capturar leads</p>
                      </div>
                    </div>
                    <p className="text-sm mb-3">
                ...
                {/* Template 3: Support Bot */}
                <Card className="cursor-pointer hover:shadow-md transition-shadow border-purple-200 bg-purple-50/30" data-testid="card-template-support-bot">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2 rounded-full bg-purple-100">
                      ...
                      <div>
                        <h3 className="font-medium">Assistente de Suporte</h3>
                        <p className="text-sm text-muted-foreground">Para atendimento técnico</p>
                      </div>
                    </div>
                    <p className="text-sm mb-3">
                ...
                {/* Template 4: Custom Bot */}
                <Card className="cursor-pointer hover:shadow-md transition-shadow border-amber-200 bg-amber-50/30" data-testid="card-template-custom-bot">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2 rounded-full bg-amber-100">
                      ...
                      <div>
                        <h3 className="font-medium">Assistente Personalizado</h3>
                        <p className="text-sm text-muted-foreground">Criado do zero</p>
                      </div>
                    </div>
                    <p className="text-sm mb-3">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Gerencie seus assistentes virtuais. Ative, desative ou edite conforme necessário.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium mb-2">Ainda sem assistentes virtuais</h3>
                <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                  Use os modelos acima para criar seu primeiro assistente virtual 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="border-green-200 bg-green-50/30">
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Seus assistentes trabalham sem parar, atendendo clientes a qualquer hora do dia ou da noite.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-blue-200 bg-blue-50/30">
              <CardContent className="p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-medium">Respostas Instantâneas</h3>
                </div>
                <p className="text-sm text-muted-foreground">
                  Não deixe mais nenhum cliente esperando. Respostas automáticas e imediatas.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-purple-200 bg-purple-50/30">
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Qualifique leads automaticamente e nunca perca uma oportunidade de venda.
                </p>
              </CardContent>
            </Card>
          </div>
