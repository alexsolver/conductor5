...
import { Plus, Calendar, Users, DollarSign, BarChart3, Filter, Search, Eye, Edit, Trash2, Settings } from 'lucide-react';
        ...
        <TabsContent value="actions" className="mt-6">
          <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Gerencie tarefas internas e externas dos projetos. Cada ação criada automaticamente gera um ticket correspondente.
            </p>
            <Button
              onClick={() => window.location.href = '/project-actions'}
