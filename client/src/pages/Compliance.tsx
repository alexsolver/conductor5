...
const clearArchitectureItems: ComplianceItem[] = [
  ...
  { name: "Score de saúde (0-100%) por módulo", status: "implemented", category: '[TRANSLATION_NEEDED]' },
  { name: "Indicadores visuais coloridos", status: "implemented", category: '[TRANSLATION_NEEDED]' },
  { name: "Métricas do sistema completas", status: "partial", category: '[TRANSLATION_NEEDED]' },
