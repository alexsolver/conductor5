          ...
          <div className="flex items-center justify-between p-4 bg-background border-b sticky top-0 z-40">
            <div className="flex items-center gap-4">
              ...
              <Button
                ...
                title={sidebarHidden ? 'Exibir menu lateral' : (sidebarCollapsed ? 'Expandir menu lateral' : 'Ocultar menu lateral')}
              >
                {sidebarHidden ? <PanelLeftOpen className="w-5 h-5" /> : (sidebarCollapsed ? <PanelLeftOpen className="w-5 h-5" /> : <PanelLeftClose className="w-5 h-5" />)}
              </Button>
