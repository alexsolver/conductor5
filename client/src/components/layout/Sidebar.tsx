...
const adminNavigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "navigation.teamManagement", href: "/team-management", icon: Users },
      { name: "navigation.contractManagement", href: "/contract-management", icon: FileText },
      { name: "navigation.expenseManagement", href: "/expense-management", icon: CreditCard },
      { name: "navigation.technicalSkills", href: "/technical-skills", icon: Award },
      ...
      { name: "navigation.activityPlanner", href: "/activity-planner", icon: Calendar },
      { name: "navigation.integrations", href: "/tenant-admin/integrations", icon: Plug },
      ...
      { name: "navigation.companies", href: "/companies", icon: Building2 },
      { name: "navigation.branding", href: "/tenant-admin/branding", icon: Palette },
      { name: "navigation.reportsAndDashboards", href: "/reports", icon: BarChart3 },
      { name: "navigation.interactiveDashboards", href: "/dashboards", icon: Activity },
    ]
  },
];
...
export function Sidebar({ collapsed, onToggleCollapse }: SidebarProps) {
  ...
  // Helper function to check if current path is within a group of paths
  const isCurrentPath = (paths: string[]) => {
