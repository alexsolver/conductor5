...
10. **refactor_code:** Refatorar dependência inválida na camada domain
...
26. **refactor_code:** Refatorar dependência inválida na camada application
...
30. **move_code:** Resolver acoplamento: Repository contém possível lógica de negócio
31. **rename_file:** Padronizar nomenclatura: Entity index não segue padrão PascalCase
...
- **knowledge-base:** 11 ações (7h)
- **materials-services:** 38 ações (28h)
